...
//    [self becomeFirstResponder]; 
    ...
    [timeSlider setMinimumTrackImage:[UIImage imageNamed:@"sliderTimeMinBBC.png"] forState:UIControlStateNormal];
    [timeSlider setThumbImage:[UIImage imageNamed:@"thumbBBC.png"] forState:UIControlStateNormal];
...
//        loadProgress = [[SevenProgressBar alloc] initWithFrame:CGRectMake(55, 358, 210, 12) andbackImg:[UIImage imageNamed:@"slider.png"] frontimg:[UIImage imageNamed:@"sliderMin.png"]];
        loadProgress = [[SevenProgressBar alloc] initWithFrame:CGRectMake(42, 443, 190, 12) andbackImg:[UIImage imageNamed:@"sliderBBC.png"] frontimg:[UIImage imageNamed:@"sliderLoadMinBBC.png"]];
        
    }else {
        loadProgress = [[SevenProgressBar alloc] initWithFrame:CGRectMake(102, 976, 490, 12) andbackImg:[UIImage imageNamed:@"sliderBBC.png"] frontimg:[UIImage imageNamed:@"sliderLoadMinBBC.png"]];
    }
    [timeSlider setMinimumTrackImage:[UIImage imageNamed:@"sliderTimeMinBBC.png"] forState:UIControlStateNormal];
