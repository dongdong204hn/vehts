...
- (void)loadView {
    ...
    if (isIphone) {
        ...
        intro = [[UILabel alloc] initWithFrame:CGRectMake(30, 10, 260, 150)];
        [buyBtn setFrame:CGRectMake(80, 170, 160, 30)];
        [recoverBtn setFrame:CGRectMake(80, 210, 160, 30)];
    } else {
    ...
    intro.autoresizingMask = UIViewAutoresizingFlexibleWidth ;
    buyBtn.autoresizesSubviews = YES;
    buyBtn.autoresizingMask = UIViewAutoresizingFlexibleWidth ;
    recoverBtn.autoresizesSubviews = YES;
    recoverBtn.autoresizingMask = UIViewAutoresizingFlexibleWidth ;
...
- (void)viewDidLoad
{
    ...
    [intro setText:@"升级为专业版,终生享受最佳体验:\n1.去除广告条!\n2.有点难？有生词？查看视频脚本(支持屏幕取词和点句播放),美语全面掌握!\n3.开启离线词库,无网环境照常查词和屏幕取词,全面提升英语能力!"];
    [intro setNumberOfLines:0];
    [intro setBackgroundColor:[UIColor clearColor]];
    [intro setTextColor:[UIColor colorWithRed:0.4 green:0.75 blue:0.17 alpha:1.0]];
    ...
    [buyBtn setBackgroundColor:[UIColor colorWithRed:0.4 green:0.75 blue:0.17 alpha:1.0]];
    ...
    [recoverBtn setBackgroundColor:[UIColor colorWithRed:0.4 green:0.75 blue:0.17 alpha:1.0]];
