...
//        _loadProgress = [[SevenProgressBar alloc] initWithFrame:CGRectMake(89, initialFrame.size.height-42, ([Constants isPad] ? 600: 200), 12) andbackImg:sliderBbcImg frontimg:loadMinImg];
        ...
        [_timeSlider setMinimumTrackImage:[UIImage imageNamed:@"sliderTimeMinBBC.png"] forState:UIControlStateNormal];
        [_timeSlider setMaximumTrackImage:[UIImage imageNamed:@"sliderLu.png"] forState:UIControlStateNormal];
        [_timeSlider setThumbImage:[UIImage imageNamed:@"thumbBBC.png"] forState:UIControlStateNormal];
        _loadProgress = [[SevenProgressBar alloc] initWithFrame:CGRectMake(189, initialFrame.size.height-42, ([Constants isPad] ? frame.size.width-100: 200), 8) andbackImg:[UIImage imageNamed:@"sliderBBC.png"] frontimg:[UIImage imageNamed:@"sliderLoadMinBBC.png"]];
...
//        self.totalTimeLabel.frame = CGRectMake(40, self.window.frame.size.height-29, 80, 25);
    ...
    else
    {
        ...
        if ([Constants isPad]) {
            ...
            [self setFrame:kIsLandscapeTest? CGRectMake(kScreenHeight + 50, 0, 300 + kFiveAdd, 180+20): CGRectMake(330, 10, 300, 190+64+20)];
        }
