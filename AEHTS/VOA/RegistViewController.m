...
//        [registBtn setImage:[UIImage imageNamed:@"myRegistBBC.png"] forState:UIControlStateNormal];
        ...
        logTable = [[UITableView alloc] initWithFrame:CGRectMake(10.0f, 30.0f, 300.0f, 180.0f) style:UITableViewStyleGrouped];
...
//        backgroundView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 300, 200)];
    ...
    logTable.autoresizingMask = UIViewAutoresizingFlexibleWidth |  UIViewAutoresizingFlexibleRightMargin;
...
- (void)catchRegists
{
    NSString *url = [NSString stringWithFormat:@"http://api.iyuba.com/mobile/ios/bbc/regist.xml?"];
