...
//                [search setFrame:CGRectMake(0, 0, 320, 44)];
                ...
                if (kIsLandscapeTest) {
                    [wordsTableView setFrame:CGRectMake(0, 0, 1024, 668)];
                    [search setFrame:CGRectMake(0, 0, 1024, 44)];
                } else {
                    [wordsTableView setFrame:CGRectMake(0, 0, 768, 916)];
...
//        [wordsTableView setFrame:CGRectMake(0, 44, 320, 372)];
        ...
        if (kIsLandscapeTest) {
            [wordsTableView setFrame:CGRectMake(0, 44, 1024, 668)];
            [search setFrame:CGRectMake(0, 0, 1024, 44)];
        } else {
...
//    [wordFrame setFrame:CGRectMake(0, 0, explainView.frame.size.width, explainView.frame.size.height)];
    ...
    [dictLabel setTextColor:[UIColor whiteColor]];
